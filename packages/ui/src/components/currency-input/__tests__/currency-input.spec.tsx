...
describe("CurrencyInput", () => {
    ...
    it("handles value prop correctly", () => {
        ...
        render(<CurrencyInput value={1234.56} onChange={handleChange} data-testid="currency-input" />);
    ...
    it("handles ref forwarding", () => {
        ...
        render(<CurrencyInput ref={ref as React.RefObject<HTMLInputElement>} data-testid="currency-input" />);
    ...
    it("supports different currency codes", () => {
        ...
        currencies.forEach((currency, index) => {
            const { unmount } = render(<CurrencyInput currency={currency} data-testid="currency-input" />);
